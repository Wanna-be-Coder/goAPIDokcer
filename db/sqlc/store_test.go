...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		require.Equal(t, -amount, fromEntry.Balance)
		...
		require.Equal(t, amount, toEntry.Balance)
		...
		require.True(t, math.Remainder(diff1, amount) == 0) // 1 * amount, 2 * amount, 3 * amount, ..., n * amount
